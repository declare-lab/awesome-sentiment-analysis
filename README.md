...
Please read this paper - [Beneath the Tip of the Iceberg: Current Challenges and New Directions in Sentiment Analysis Research](https://declare-lab.net/assets/pdfs/Sentiment_Analysis_New_Directions.pdf) for our take on the current challenges and future directions of this field using the following papers as compass.
